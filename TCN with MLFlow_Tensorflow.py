...
needed_columns_g = ['plantLengthChange']  
growth_data_2 = growth_data_1[needed_columns_g]
...
needed_columns_e = ['in_co2', 'in_humidity', 'in_temp']  
environment_data_2 = environment_data_1[needed_columns_e]
